...
using Sysmon Process Creation events (Event ID 1).

> Focused on SOC triage and baseline analysis, not incident response.
...
These techniques are commonly observed during initial access,
execution, and post-exploitation phases.
